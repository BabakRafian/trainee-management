...
var trainees = [{trainee_id: '1552200', email: 'cwmason@crimson.ua.edu', firstname: 'Connor', lastname: 'Mason', batch_id: 'JUN_18_1', password: 'nottodaysatan', city_preferences: [{Ohio: 'cincinnati'},{Texas: 'austin'},{Colorado: 'denver'}], domain_preferences: ['banking', 'front-end', 'data science']},{trainee_id: '1773300', email: 'something@gmail.com', firstname: 'Loser', lastname: 'Notsmart', batch_id: 'JUL_18_4', password: 'password'}];
